                ...
                try {
                    ...
                    if(resultType.equals("success"))
                    {
                        ...
                        for(int i = 0;i < totalPosts;i++)
                        {
                            ...
                            String pid = current.getString("postid");
                            ...
                            ((HomeActivity)getContext())
                                     .runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Picasso.get()
                                                    .load(Constants.SERVER_ADDRESS + "/media/posts/" + url)
                                                    .into(imageView);
                                        }
                                    });
                        }
                ...
                try {
                    ...
                    if(type.equals("success")) {
                        ...
                        for(int i = 0;i < rowCount;i++) {
                            ...
                            HomeProfileFragment.this.category = category;
                            HomeProfileFragment.this.name = name;
                            HomeProfileFragment.this.status = status;
                            HomeProfileFragment.this.handler= email;
