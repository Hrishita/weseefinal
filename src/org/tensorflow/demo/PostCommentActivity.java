...
public class PostCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CommentAdapter(PostCommentActivity.this, arrayList);
                    ...
                    send.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if(!comment.getText().toString().equals("")) {
                                ...
                                CommentInteractionTask task2 = new CommentInteractionTask(PostCommentActivity.this, new CommentInteractionTask.CommentTaskCallback() {
                                    @Override
                                        ...
                                        try{
                                            ...
                                            if(type.equals("success")) {
                                                ...
                                                runOnUiThread(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        Toast.makeText(PostCommentActivity.this, "Failed To Upload Comment", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                        } catch (Exception e ){
    ...
    private void loadComments() {
                CommentInteractionTask task = new CommentInteractionTask(PostCommentActivity.this, new CommentInteractionTask.CommentTaskCallback() {
                    @Override
                    public void finish(String s) {
                        ...
                        try {
                            ...
                            if(type.equals("success")) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(PostCommentActivity.this, "Failed To Load Comment", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
