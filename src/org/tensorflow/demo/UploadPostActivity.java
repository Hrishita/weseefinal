...
public class UploadPostActivity extends AppCompatActivity {
    ...
    UploadPostImagesAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new UploadPostImagesAdapter(UploadPostActivity.this, arrayList);
        recyclerView.setAdapter(adapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(UploadPostActivity.this, LinearLayoutManager.HORIZONTAL, false));
