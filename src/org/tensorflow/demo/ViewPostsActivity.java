...
public class ViewPostsActivity extends AppCompatActivity {
        ...
        FirebaseAuth.getInstance().getCurrentUser().getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
            ...
            public void onComplete(@NonNull Task<GetTokenResult> task) {
                if(task.isSuccessful()) {
                    ...
                    adapter = new ViewPostAdapter(ViewPostsActivity.this, arrayList, phoneNumber, task.getResult().getToken());
                    ...
                    chat.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent i = new Intent(ViewPostsActivity.this, ChatActivity.class);
                            startActivity(i);
                        }
                    });
    ...
    private void gotoPostActivity() {
        Intent i = new Intent(ViewPostsActivity.this, UploadPostActivity.class);
        startActivity(i);
    }

    private void gotoProfileActivity() {
        Intent i = new Intent(ViewPostsActivity.this, ProfileActivity.class);
        startActivity(i);
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(ViewPostsActivity.this, "Loading From Server", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                try {
                    ...
                    if(type.equals("success")) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                progressBar.setVisibility(View.GONE);
                                Toast.makeText(ViewPostsActivity.this, "Failed to load data", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
