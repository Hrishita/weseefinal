                    ...
                    task.getResult().getUser().getIdToken(true).addOnCompleteListener(new OnCompleteListener<GetTokenResult>() {
                        ...
                        public void onComplete(@NonNull final Task<GetTokenResult> task) {
                            if(task.isSuccessful()) {
                                ...
                                final LoginTask loginTask = new LoginTask(PhoneAuthActivity.this, new ResponseListener() {
                                    @Override
                                    public void sendResponse(String jsonResponse) {
                                        try {
                                            ...
                                            if(jsonObject.getString("type").equals("success")) {
                                                ...
                                                Toast.makeText(PhoneAuthActivity.this, "Failed To Connect With Database", Toast.LENGTH_SHORT).show();
                                            }
                                        } catch (Exception e) {
                                            e.printStackTrace();
                                        }
