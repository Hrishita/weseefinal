...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GetProfileTask task = new GetProfileTask(ProfileActivity.this, new GetProfileTask.ProfileReceivedListener() {
            @Override
...
//                                });
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final RegisterTask registerTask = new RegisterTask(ProfileActivity.this, new RegisterCallbackListener() {
                    @Override
...
//                        Toast.makeText(ProfileActivity.this, string, Toast.LENGTH_SHORT).show();
                ...
                if(et_name.getText().toString().equals("")) {
                    ...
                    cat = "";
                    Toast.makeText(ProfileActivity.this, "Please Select A Category", Toast.LENGTH_SHORT).show();
                }
                if(!cat.equals("")) {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ProfileActivity.this, "Failed to Reject", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ProfileActivity.this, "Failed To Deny Request", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
